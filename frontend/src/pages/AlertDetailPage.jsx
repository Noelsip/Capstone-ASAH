...
import { getPredictionDetail } from '../api/predictions';
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between border-b pb-4">
                <h1 className="text-3xl font-bold text-gray-800">Alert Detail: {alert.title || alert.detail || alert.id}</h1>
                <button 
            ...
            <div className="grid grid-cols-3 gap-6 bg-white p-6 rounded-xl shadow-lg border">
                ...
                <div className="col-span-2 space-y-6">
                    <span className={`px-3 py-1 rounded-full text-xs font-semibold uppercase ${
                        ...
                        alert.severity === 'Warning' ? 'bg-yellow-400 text-white' :
                        'bg-green-600 text-white'
                    }`}>
                        {alert.severity}
                    </span>
                    <h3 className="text-xl font-semibold text-gray-700">Description</h3>
                    <p className="text-gray-600">{alert.description || alert.detail}</p>
